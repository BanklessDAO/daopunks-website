...
export default function Wallet() {
  ...
  return (
    <div className={`h-screen flex flex-col`}>
      ...
      {hasAccess || process.env.REACT_APP_REDEEM_ENABLED === "true" ? (
        ...
        <div className="w-full h-full flex items-center justify-center modius-bold">
          <div style={{ maxWidth: "18rem" }} className="mt-10 mb-5">
